...
$items = demo_jobs();
page_header('Estagios e Empregos');
?>
<section class="section section-lg pt-5">
<div class="container">
    <h1 class="section-title h3 mb-4">Estagios e Empregos</h1>
        ...
        <?php foreach ($items as $item): ?>
            <div class="col-md-6 col-xl-4 mb-4">
                <a class="card card-link news-card h-100" href="/noticias/ver.php?slug=<?= urlencode($item['slug']) ?>">
                    ...
                    <div class="card-body">
                        <span class="badge badge-dark mb-2"><?= e($item['category']) ?></span>
                        <h2 class="h5 mb-2"><?= e($item['title']) ?></h2>
                        <p class="news-summary mb-3"><?= e($item['summary']) ?></p>
                        <span class="news-cta">Ver vaga</span>
                    </div>
                </a>
            </div>
        <?php endforeach; ?>
